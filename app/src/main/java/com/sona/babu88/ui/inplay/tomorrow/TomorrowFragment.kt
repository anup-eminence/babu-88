package com.sona.babu88.ui.inplay.tomorrow
...
import com.sona.babu88.databinding.FragmentTomorrowBinding
import com.sona.babu88.ui.inplay.today.TodayAdapter
...
class TomorrowFragment : Fragment(), TodayAdapter.OnTodayClickListener {
    ...
    private fun setCricketAdapter() {
        ...
        todayAdapter.setOnItemClickListener(this@TomorrowFragment)
    ...
    private fun setSoccerAdapter() {
        ...
        todayAdapter1.setOnItemClickListener(this@TomorrowFragment)
    ...
    private fun setTennisAdapter() {
        ...
        todayAdapter2.setOnItemClickListener(this@TomorrowFragment)
    ...
    private fun observerToday() {
        sportsViewModel.getTomorrowMatches()
        sportsViewModel.tomorrowMatches.observe(viewLifecycleOwner) { it ->
            when (it) {
